	...
	public static function getSupportParam($type)
	{
		switch($type)
		{
			case 'obfs':
				...
				return $list;
			case 'protocol':
				$list = array('origin', 'verify_deflate', 'auth_sha1', 'auth_sha1_compatible', 'auth_sha1_v2', 'auth_sha1_v2_compatible',
							'auth_sha1_v4', 'auth_sha1_v4_compatible', 'auth_aes128_sha1', 'auth_aes128_md5');
				return $list;
			default:
