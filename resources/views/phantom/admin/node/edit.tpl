...
<div id="main">
	...
	<section>
		...
		<div class="12u 12u$(xsmall)">
			...
			<input type="text" id="name" class="form-control" value="{$node->name}"/>
		</div>
		...
		<div class="12u 12u$(xsmall)">
			...
			<input type="text" id="method" class="form-control" value="{$node->method}"/>
		</div>
		
		<div class="12u 12u$(xsmall)">
			<label class="control-label">流量比率</label>
			<input type="text" id="rate" class="form-control" value="{$node->traffic_rate}"/>
		</div>
	...
	<section>
		<legend>描述信息</legend>
			...
			<div class="12u 12u$(xsmall)">
				...
				<input type="text" id="status" class="form-control" value="{$node->status}"/>
			</div>
			
			<div class="12u 12u$(xsmall)">
				<label class="control-label">类型（SS=0,VPN=1.....请看 zhaojin97.cn）</label>
				<input type="text" id="sort" class="form-control" value="{$node->sort}"/>
			</div>
			
			<div class="12u 12u$(xsmall)">
				<label class="control-label">节点描述</label>
				<input type="text" id="info" class="form-control" value="{$node->info}"/>
			</div>
			
			<div class="12u 12u$(xsmall)">
				<label class="control-label">节点类别（不分类请填0，分类为数字）</label>
				<input type="text" id="class" class="form-control" value="{$node->node_class}"/>
			</div>

			<div class="12u 12u$(xsmall)">
				<label class="control-label">节点流量上限（不使用的话请填0）</label>
				<input type="text" id="node_bandwidth_limit" class="form-control" value="{$node->node_bandwidth_limit/1024/1024/1024}"/>
			</div>
