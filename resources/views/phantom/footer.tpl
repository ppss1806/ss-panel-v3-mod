				...
				<!-- Footer -->
					<footer id="footer">
						<div class="inner">
							...
							<ul class="copyright">
								<li>&copy; {$config["appName"]}  Powered by <a class="orange-text text-lighten-3" href="https://github.com/orvice/ss-panel">ss-panel</a> {$config["version"]} 部分图片资源来自互联网</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</footer>
		...
		<!-- Scripts -->
			...
			<script src="/theme/phantom/assets/js/main.js"></script>
